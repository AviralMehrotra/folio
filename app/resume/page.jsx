...
const about = {
  ...
  info: [
    {
      fieldName: "Name",
      fieldValue: "Aviral Mehrotra",
    },
    {
      fieldName: "Phone",
      fieldValue: "+91 12345 67890",
    },
    {
    ...
    {
      fieldName: "Email",
      fieldValue: "aviralmehrotra9402@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const experience = {
  ...
  title: "Experience",
  description:
    "Gained practical experience through multiple internships, working on real-world projects involving web development, API integration, and full-stack application development.",
  items: [
    {
      company: "EKAM Solutions",
      position: "Software Developer Intern",
      duration: "July 2025 - September 2025",
    },
    {
      company: "R.G Minerals",
      position: "Web Developer Intern",
      duration: "July 2023 - August 2023",
    },
    {
      company: "Mayatech Solutions Pvt. Ltd.",
      position: "Web Developer Intern",
...
const education = {
  ...
  title: "Education",
  description:
    "Currently pursuing BTech in Computer Science with a focus on software development, data structures, and modern web technologies.",
  items: [
    {
...
const skills = {
  title: "My Skills",
  description:
    "Proficient in modern web technologies and frameworks for building responsive, scalable applications with clean, maintainable code.",
  skillList: [
    {
      name: "React",
      icon: <SiReact />,
                  ...
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {education.items.map((item, index) => {
                      return (
                        ...
                        >
                          <span className="text-accent">{item.duration}</span>
                          <h3 className="text-xl max-w-[340px] min-h-[60px] text-center lg:text-left">
                            {item.degree}
                          </h3>
                          <div className="flex items-center gap-3">
                            <span className="w-[6px] h-[6px] rounded-full bg-accent"></span>
